...
const Skills = () => {
  return (
    <div className="px-16 py-20 bg-green-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 p-6 gap-y-28">

        {/* Full Stack */}
        <div className="p-6 bg-green-100 rounded-2xl shadow-md w-full max-w-md mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            {[
              ...
              <div key={idx} className="relative group">
                <img src={tech.src} alt={tech.label} className="h-8" />
          ...
          <ul className="space-y-3 text-sm text-blue-900">
            <li className="flex items-start">
              ...
              <span>Developed responsive and dynamic web interfaces using React</span>
            </li>
            <li className="flex items-start">
              <FaFire className="text-orange-500 mt-1 mr-2" />
              <span>Developing web applications using MERN</span>
            </li>
            <li className="flex items-start">
              <FaFire className="text-orange-500 mt-1 mr-2" />
              <span>Engineered robust backend services using Node.js, Express, and Flask for scalable web applications.</span>
            </li>
          </ul>
        </div>
        ...
        <div className="p-6 bg-green-100 rounded-2xl shadow-md w-full max-w-md mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            {[
              ...
              <div key={idx} className="relative group">
                <img src={tool.src} alt={tool.label} className="h-8" />
                <span className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-black text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  {tool.label}
                </span>
              </div>
          ...
          <ul className="space-y-3 text-sm text-blue-900">
            <li className="flex items-start">
              <FaFire className="text-orange-500 mt-1 mr-2" />
              <span>Crafted visually compelling user interfaces tailored for both mobile and web platforms.</span>
            </li>
            <li className="flex items-start">
              <FaFire className="text-orange-500 mt-1 mr-2" />
              <span>Designed and customized brand logos from the ground up to align with client identity and vision.</span>
            </li>
            <li className="flex items-start">
              <FaFire className="text-orange-500 mt-1 mr-2" />
              <span>Mapped and implemented user journey flows to enhance usability and streamline application functionality.</span>
            </li>
          </ul>
        </div>
        ...
        <div className="p-6 bg-green-100 rounded-2xl shadow-md w-full max-w-md mx-auto">
          ...
          <ul className="space-y-3 text-sm text-blue-900">
            <li className="flex items-start">
              <FaFire className="text-orange-500 mt-1 mr-2" />
              <span>Experience working on cloud platforms</span>
            </li>
            <li className="flex items-start">
              <FaFire className="text-orange-500 mt-1 mr-2" />
              <span>Hosting and maintaining websites on virtual machine instances along with integration of databases</span>
            </li>
          </ul>
        </div>
