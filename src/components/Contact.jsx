      ...
      <div className="flex flex-col md:flex-row items-center gap-60">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-slate-600 max-w-lg mb-6">
            I am available on social media. You can message me, I will reply within 24 hours.
            I can help you with React, ML, AI, Cloud and Opensource Development.
          </p>
          {/* Social Icons */}
          <div className="flex justify-center md:justify-start gap-4 text-2xl mb-4">
            <a href="https://github.com/Arun-Vijay-AP" target="_blank" rel="noreferrer"><FaGithub className="hover:text-black" /></a>
            <a href="https://www.linkedin.com/in/arun-vijay-ap/" target="_blank" rel="noreferrer"><FaLinkedin className="hover:text-blue-700" /></a>
            <a href="https://twitter.com/" target="_blank" rel=" noreferrer"><FaXTwitter className="hover:text-black" /></a>
            <a href="mailto:arunvijaypalanisamy@gmail.com" target="_blank" rel="noopener noreferrer"><FaEnvelope className="text-2xl text-gray-700 hover:text-red-500" /></a>
          </div>
          <a
